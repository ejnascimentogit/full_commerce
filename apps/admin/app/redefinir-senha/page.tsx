  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4">
      <div className="bg-white rounded-lg p-8 w-full max-w-sm">
        ...
        {!accessToken ? (
          <>
            <p className="text-sm text-slate-500 mb-6">Link inválido ou expirado.</p>
            <Link href="/esqueci-senha" className="text-brand-600 font-medium hover:underline text-sm">
              Pedir um novo link
            </Link>
          </>
        ) : done ? (
