...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <div className="relative bg-white rounded-lg border border-slate-200 shadow-md shadow-slate-300/40 hover:bg-brand-50/60 hover:border-brand-500 hover:shadow-lg hover:shadow-brand-500/25 hover:-translate-y-0.5 transition-all flex flex-col">
